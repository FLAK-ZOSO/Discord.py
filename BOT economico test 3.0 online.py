...
async def Aiuto_Account(ctx):
    await ctx.send("syntax: $Account dichiarazione_cittadino dichiarazione_lavoro")
...
async def Account(ctx, dichiarazione_cittadino, dichiarazione_lavoro):
    eval(dichiarazione_cittadino) #eval() non funziona per le assegnazioni
    eval(dichiarazione_lavoro) #eval() non funziona per le assegnazioni
